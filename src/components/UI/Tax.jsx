// image
import financial from '../../assets/image/tax.jpg'
...
const Tax = () => {
  ...
  return (
    <>
            <div className='flex flex-col justify-start items-start gap-5 text-sm lg:text-base'>
                ...
                <div className="py-5 flex flex-col justify-start items-start gap-5">
                    <h2 className="text-xl lg:text-3xl font-medium lg:font-bold">Konsultasi Perpajakan</h2>
