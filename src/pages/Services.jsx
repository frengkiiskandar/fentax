...
const Services = () => {
  return (
    <div>
      ...
      {/* Services */}
      <section className="py-5 px-3 lg:px-20 lg:py-10 text-sm lg:text-base">
        <section className="w-full flex flex-col lg:flex-row flex-wrap justify-start items-start gap-5 lg:10">
          <div className="w-full lg:w-1/3 ">
            ...
            <div className="w-full mt-10 px-5 lg:px-10 py-5 flex flex-col justify-center items-center shadow-2xl rounded-lg border">
              <h3 className="text-xl font-medium lg:font-semibold">
                Tinggalkan Kontak Anda
              </h3>
              <p>Kami akan menghubungi</p>
              <form
                action=""
                className="w-full mt-5 flex flex-col justify-center items-center gap-5"
              >
                <input
                  type="text"
                  className="w-full px-4 py-2 outline-none shadow-md border-b-[1px] border-choco"
