    ...
    <>
      <main className="text-xs lg:text-base bg-white text-black">
        ...
        <section className="py-10 lg:py-20 px-3 md:px-[5%] lg:px-[15%]  flex flex-wrap justify-between items-center gap-5 lg:gap-20 ">
          <div className="lg:w-450px] lg:h-[500px] overflow-hidden rounded-lg flex flex-col justify-center items-center">
            <img
              src={showing1}
              alt=""
              className="lg:w-full h-full object-fill w-3/4"
            />
          </div>
          <div className="flex-1 py-10 flex flex-col justify-start items-start gap-5">
            <h3 className="tont-semibold">
              Solusi Perpajakan Profesional & Terpercaya
            </h3>
            <h1 className="text-2xl font-medium lg:text-4xl">
              Mitra Profesional untuk Kepatuhan Pajak Anda
            </h1>
            <p>
              Kami menyediakan layanan konsultasi perpajakan yang akurat, patuh
              regulasi, dan efisien untuk individu maupun perusahaan. Dengan tim
              konsultan berpengalaman, kami membantu Anda mengelola kewajiban
              pajak secara optimal dan tepat waktu
            </p>
            ...
            <button className="text-white px-4 py-2 lg:px-7 lg:py-3 rounded-md font-medium lg:font-semibold bg-choco">
              Selengkapnya
            </button>
          </div>
        </section>
        ...
        <section className="w-full  px-5 py-10 lg:py-20 flex flex-col justify-center items-center gap-10 bg-primary text-center text-white">
          <div>
            <h1 className="mb-5 text-2xl lg:text-4xl font-medium lg:font-bold">
              Kami Memiliki<span className="text-choco"> Dedikasi Tinggi</span>{" "}
              dalam Konsultasi Perpajakan
            </h1>
            <p className="px-0 lg:px-10">
              Kami berkomitmen memberikan layanan konsultasi pajak yang akurat,
              patuh regulasi, dan berorientasi pada solusi. Dengan pengalaman
              dan pemahaman mendalam terhadap peraturan perpajakan Indonesia,
              kami membantu klien mengelola kewajiban pajak secara efektif dan
              berkelanjutan.
            </p>
          </div>
        ...
        <section className="px-5 py-10 lg:py-20 flex flex-col justify-center items-center gap-5 text-center">
          ...
          <p className="lg:w-2/3">
            Kami menerapkan proses kerja yang terstruktur, transparan, dan
            berorientasi pada solusi untuk memastikan setiap kebutuhan
            perpajakan klien ditangani secara tepat dan profesional.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-10 lg:flex lg:flex-row lg:justify-end text-white ">
            ...
            <div className="px-5 py-7 md:col-span-2 lg:col-span-1 flex-1 flex-col justify-center items-center gap-5 bg-primary ">
              ...
              <div className="flex flex-col justify-center items-center gap-3 mt-2">
                ...
                <p>
                  Pelaksanaan tepat, patuh dan memberikan kepastian bagi klien
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative w-full h-56 lg:h-96 border border-blue-70 overflow-hidden text-white">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center gap-5 text-center p-4 lg:p-8">
              <h2 className="text-xl lg:text-5xl font-medium lg:font-semibold ">
                Masih Bingung Mengelola{" "}
                <span className="text-choco">Pajak Anda?</span> Konsultasikan
                Sekarang
              </h2>
              <p>
                Kami siap membantu Anda mengelola kewajiban perpajakan secara
                tepat, patuh regulasi, dan efisien. Dapatkan pendampingan
                profesional sesuai kebutuhan Anda.
              </p>
              <button className="px-5 py-3 lg:px-7 lg:py-3 bg-choco rounded-lg">
                Kontak Kami
              </button>
            </div>
          </div>
        ...
        <section className="py-5 md:py-10 lg:py-20 flex flex-col justify-center items-center gap-10 lg:gap-20">
          <div className="flex flex-wrap justify-center items-center gap-10 lg:gap-28 text-center">
            <div className="w-60 min-h-36 flex flex-col justify-center items-center gap-1 lg:gap-3 rounded-lg ">
              ...
              <p className="text-lg lg:text-xl">
                Efisiensi & Optimalisasi Pajak
              </p>
              <p>
                Membantu mengelola kewajiban pajak secara efisien untuk
                mengoptimalkan keuangan bisnis Anda.
              </p>
            </div>
            <div className="w-60 min-h-36 flex flex-col justify-center items-center gap-1 lg:gap-3 rounded-lg">
              <div className="border p-2 lg:p-3 bg-choco text-white rounded-md">
              ...
              <p>
                Didukung tim konsultan berpengalaman yang siap memberikan solusi
                perpajakan sesuai kebutuhan Anda.
              </p>
            </div>
            <div className="w-60 min-h-36 flex flex-col justify-center items-center gap-1 lg:gap-3 rounded-lg">
              <div className="border p-2 lg:p-3 bg-choco text-white rounded-md">
              ...
              <p>
                Solusi perpajakan yang tepat membantu bisnis Anda tumbuh lebih
          ...
          <section className="flex flex-col justify-center items-center gap-5 lg:gap-10 ">
            <h2 className="px-5 py-2 text-black text-xs lg:text-sm bg-accent w-fit rounded-full lg:font-medium">
              Tim Kami
            </h2>
          ...
          <div className="px-3 md:px-[5%] lg:px-[15%] ">
            <Tagline />
          </div>
        </section>
      </main>
