...
const Homepage = () => {
  return (
    <>
    <section className=' bg-primary px-3 md:px-[5%] lg:px-[15%] overflow-border border-red-400'>
        ...
        <section className='py-24 px-10 md:px-[5%] lg:px-[15%] flex flex-col justify-center items-center gap-10 bg-[#F3F4F2] text-center'>
            ...
            <div className=' flex flex-wrap justify-center items-center gap-7'>
                <div className='flex flex-col justify-center items-center gap-3 max-w-96 text-center'>
                    ...
                    <p className='text-sm'>Optimalkan proses bisnis dan kepatuhan pajak perusahaan.</p>
                </div>
                <div className='flex flex-col justify-center items-center gap-3 max-w-96 text-center'>
                    <div className=' w-20 p-5 rounded-full bg-buttonClr'>
                        <img src={book} alt="" />
                    ...
                    <p className='text-sm'>Rancang strategi pajak tepat untuk pertumbuhan bisnis.</p>
                </div>
                <div className='flex flex-col justify-center items-center gap-3 max-w-96 text-center'>
                    <div className=' w-20 p-5 rounded-full bg-buttonClr'>
                        <img src={chart} alt="" />
